            ...
            messages: [
                {
                    role: 'system',
                    content: `
You are a prompt enhancement specialist. The user wants to make changes to their website.
Enhance the request to be clear, specific, and actionable for a web developer.

Return ONLY the enhanced request (1–2 sentences).
`
                },
                {
                    role: 'user',
...
export const rollbackToVersion = async (req: Request, res: Response) => {
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: 'assistant',
                content: "I've rolled back your website to the selected version. You can preview it.",
                projectId
            }
        })
