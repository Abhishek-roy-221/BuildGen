import { CircleIcon, ScalingIcon, SquareIcon, TriangleIcon } from "lucide-react"
import { useEffect, useState } from "react"


const steps = [
    { icon: ScalingIcon, label: "Analyzing your request..." },
    { icon: SquareIcon, label: "Analyzing your request..." },
    { icon: TriangleIcon, label: "Analyzing your request..." },
    { icon: CircleIcon, label: "Analyzing your request..." }
]
...
const LoaderSteps = () => {
    ...
    relative overflow-hidden text-white">
      ...
      to-fuchsia-500/10 blur-3xl animate-pulse">
            ...
            {/* step label - fade using transition */}
